...
<template>
  <div class="p-10">
    <h1 class="text-lg font-bold mb-4">模运算</h1>
    ...
    <el-collapse v-model="collapseVal">
      ...
      <el-collapse-item name="mod-div">
        ...
        <p>
          要计算：<span class="text-[12px] px-2"><katex formula="\frac{a}{b} \mod p" /> </span> 由于
          不能直接除法，可以转换为 乘法：
          <span class="text-[12px] px-2">
        ...
        <p class="indent-4">
          ...
          可化简为<span class="text-[12px] px-2"><katex formula="7 * 2^{-1} \bmod 5"></katex></span>
          此时 根据模逆
