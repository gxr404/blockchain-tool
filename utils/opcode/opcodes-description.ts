...
export const opcodeDescription: {
  ...
  OP_NOP: '空操作码, 无任何操作, 执行到此操作码时会被忽略, 继续执行下一个操作码',
  ...
  OP_LEFT: '出栈 2 个元素, 分别表示 size、 string, 将 string 的左边 size 长度的子串入栈',
  OP_RIGHT: '出栈 2 个元素, 分别表示 size、 string, 将 string 的右边 size 长度的子串入栈',
  OP_SIZE: '将栈顶元素的长度入栈',
  ...
  OP_LESSTHAN: '出栈 2 个元素, 如果第二个元素小于第一个元素则入栈 1, 否则入栈 0',
  OP_GREATERTHAN: '出栈 2 个元素, 如果第二个元素大于第一个元素则入栈 1, 否则入栈 0',
  OP_LESSTHANOREQUAL: '出栈 2 个元素, 如果第二个元素小于等于第一个元素则入栈 1, 否则入栈 0',
  OP_GREATERTHANOREQUAL: '出栈 2 个元素, 如果第二个元素大于等于第一个元素则入栈 1, 否则入栈 0',
  OP_MIN: '出栈 2 个元素, 取最小值入栈',
  OP_MAX: '出栈 2 个元素, 取最大值入栈',
  OP_WITHIN: '出栈 3 个元素分别为 max、min、x, 如果 min <= x < max 则入栈 1, 否则入栈 0',
